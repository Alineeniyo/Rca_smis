...
<body>
<div class="container">
<%--	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBJqUd1yQnfvPFMhIIhJl0-3MwvTjZvumkr5DxJGyMi_qXg14tBLcvAH0dBCtQ3HeBCOs&usqp=CAU" alt=" Logo">--%>
	<h2>Sign In</h2>
	...
	<form action="login.php" method="post">
		...
		<p>Don't have an account<span><a href="createuser.php?page=createuser"> Create new user</a>	</span></p>
